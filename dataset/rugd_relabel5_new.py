...
rudg_dir = "/home/maplexe/Dataset/RUGD/"
...
# 0 background/Obstacle: sky, tree, pole, vehicle, container/generic object, bicycle, person, fence, sign, bridge, table, building, water
# 1 Stable: Concrete, Asphalt 
# 2 Granular: Sand, Dirt, mulch, gravel
# 3 High resistance: grass, bush, log, rocks, rockbed
# Groups = [2, 2, 2, 5, 5, 4, 0, 5, 5, 1, 2, 5, 2, 3, 5, 5, 5, 5, 5, 0, 3, 5, 1, 5]
Groups = [2, 2, 3, 0, 0, 0, 0, 0, 0, 1, 2, 0, 2, 3, 3, 0, 0, 0, 3, 0, 3, 0, 1, 0]
...
#         out2 = raw_to_seq(out)
#         mmcv.imwrite(out2, rudg_dir + annotation_folder + l.strip() + "_group5.png")
