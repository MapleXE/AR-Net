...
rellis_dir = "/home/maplexe/Dataset/RELLIS-3D/"
...
Groups = (0, 2, 3, 0, 0, 0, 0, 0, 0, 1, 0, 3, 0, 0, 3, 1, 0, 0, 2, 2)
...
# 2 -- Granular: dirt, mud, rubble
# 3 -- High resistance: grass, bush, log
...
with open(osp.join(rellis_dir, 'train.txt'), 'r') as r:
    ...
    for l in r:
        ...
        img_bytes = file_client.get(rellis_dir + annotation_folder + l.strip() + '_orig.png')
        ...
        mmcv.imwrite(out2, rellis_dir + annotation_folder + l.strip() + "_group5.png")
